...
<script>
import { getFemcNotifyRule, getFemcNotifyToken, getFemcNotifySetting, postFemcNotifySetting, getCaseOption, getSystemStorageSetting, postSystemStorageSetting } from "@/api/Api.js";
    ...
    Submit() {
      ...
      vm.$refs.form.validate((valid) => {
        if (!valid) {
          ...
          vm.$loading();
          postFemcNotifySetting({ data_list: postData })
            .then((resopnse) => {
              if (resopnse.data.message == "Success") {

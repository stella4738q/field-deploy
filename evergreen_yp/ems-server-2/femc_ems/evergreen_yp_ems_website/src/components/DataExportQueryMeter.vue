<template>
  ...
  <el-table-column min-width="15%" align="center" label="設備" prop="equipment_id"></el-table-column>
  ...
  <el-row class="mobile-table">
    <el-col :xs="24" :sm="12" v-for="(item, index) in DataExportData" :key="index" class="mb-2">
      <div class="card">
        <div class="card-header">
          <div class="label-style">設備</div><span class="text-primary">{{ item.equipment_id }}</span>
        </div>
        <ul class="card-body">
